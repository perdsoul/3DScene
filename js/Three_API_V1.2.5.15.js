...
(function () {
    ...
    workerLoadVsg.onmessage = function (event) {
        ...
        // console.log(sceneConfigMap[currentBlockName]);
    ...
    function DrawModel(tag) {
        ...
        // console.log(drawDataMap[currentBlockName]);
                            ...
                            if(modelDataV[currentBlockName][newName])
                            {
                                ...
                                for(var dataCount=0;dataCount<modelDataV[currentBlockName][newName].length;dataCount++)
                                {
                                    ...
                                    for (var j = 0; j < modelDataV[currentBlockName][newName][dataCount].length; j += 3) {
                                        ...
                                        // else 276421	78773.5	-400
                                        groupV = new THREE.Vector3(-newN1+offsetX, newN3-offsetZ, newN2-offsetY);
                                        vMetrix.push(groupV);
                                    }
    ...
    function getComponentByNameAndPoint(name, point) {
        ...
        var indexX = Math.ceil((point.x / sceneConfigMap[currentBlock].scale - sceneConfigMap[currentBlock].sceneBBoxMinX )/sceneConfigMap[currentBlock].voxelSize) ;
        ...
        var voxelizationFileArr = sceneConfigMap[currentBlock].vsg[index];
