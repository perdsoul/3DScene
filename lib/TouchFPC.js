...
THREE.TouchFPC = function ( object, domElement ) {
    ...
    this.domElement.addEventListener( 'touchstart', bind( this, this.touch), true );
    this.domElement.addEventListener( 'touchend', bind( this, this.touch), true );
    this.domElement.addEventListener( 'touchmove', bind( this, this.touch), true );
